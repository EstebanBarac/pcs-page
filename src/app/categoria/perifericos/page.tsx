...
export default function PcsNuevasGraficasOutletPage() {
  ...
  useEffect(() => {
    async function loadProducts() {
      setLoading(true)
      const fetchedProducts = await getProductsByCategory(2) // Asumiendo que 2 es el ID de la categoría
  ...
  <div className="container mx-auto px-4 py-8">
    <h1 className="text-4xl font-bold mb-8 text-center text-white">Periféricos</h1>
