...
export default function PcsNuevasGraficasOutletPage() {
  ...
  <div className="container mx-auto px-4 py-8">
    <h1 className="text-4xl font-bold mb-8 text-center text-white">PCs con Gráficas RTX Series 40 Nuevas</h1>
          ...
          <div className="p-6">
            ...
            <div className="flex justify-between items-center">
              ...
              <Link
                ...
                className="bg-gradient-to-r from-[#FF512F] to-[#F09819] px-4 py-3 rounded-full hover:opacity-75 transition duration-300"
              >
                Ver detalles
              </Link>
            </div>
